...
async def Page(request: Request):
    ...
    return templates.TemplateResponse("index(Ver_4).html", {"request": request, "temperature": temp, "humidity": hum, "lamp": lamp,"people_count": ncnt_people, "last_time": current_time, "get_time": current_time})
